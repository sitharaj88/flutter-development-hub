...
- the team learns in context while the product continues moving forward

## How to choose the right model

- choose advisory when decisions matter more than hands-on development
- choose sprint support when delivery speed and technical quality both matter
- choose team acceleration when internal capability is the strategic goal
- choose rescue work when the current codebase is blocking safe progress
- choose blended work when the team needs to learn and deliver at the same time
